...
We download SATA,SPSS, and SAS from NORC. Norc offers real data from this university and we will use the different formats.We will use code to generate our bargraphs. We will also be using the helper file Cat~Cat to complete this project.
